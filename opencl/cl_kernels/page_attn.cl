...
//====================================================
// Kernel template: pa_sdpa_opt_multi_tokens 
// Kernel name: pa_sdpa_opt_multi_tokens
#define KERNEL(name) __kernel void pa_sdpa_opt_multi_tokens
#define KERNEL_ID pa_sdpa_opt_multi_tokens
#define FUNC(name)  _##name##_pa_sdpa_opt_multi_tokens
#define FUNC_CALL(name)  _##name##_pa_sdpa_opt_multi_tokens
#define CONST_ARRAY_DECL(name) __constant size_t  _##name##_pa_sdpa_opt_multi_tokens []
#define CONST_ARRAY_REF(name)  _##name##_pa_sdpa_opt_multi_tokens
...
#define INPUT0_FEATURE_NUM 5120
...
#define INPUT0_BATCH_PITCH (1*1*1*1*1*1*5120)
...
#define INPUT1_FEATURE_NUM 5120
...
#define INPUT1_BATCH_PITCH (1*1*1*1*1*1*5120)
...
#define INPUT2_FEATURE_NUM (5120 )
...
#define INPUT2_PAD_BEFORE_FEATURE_NUM (shape_info[24])
...
#define INPUT2_PAD_AFTER_FEATURE_NUM (shape_info[25])
...
#define INPUT2_BATCH_PITCH (1*1*1*1*1*1*(5120  + (shape_info[24] + shape_info[25])))
...
#define INPUT3_Y_PITCH 1
#define INPUT3_Z_PITCH (1*1)
#define INPUT3_W_PITCH (1*1*1)
#define INPUT3_U_PITCH (1*1*1*1)
#define INPUT3_V_PITCH (1*1*1*1*1)
#define INPUT3_FEATURE_PITCH (1*1*1*1*1*1)
#define INPUT3_BATCH_PITCH (1*1*1*1*1*1*1)
...
#define INPUT3_TYPE int
#define INPUT3_VAL_MAX INT_MAX
#define INPUT3_VAL_MIN INT_MIN
#define INPUT3_VAL_ONE (int) 1
#define INPUT3_VAL_ZERO (int) 0
#define TO_INPUT3_TYPE(v) convert_int(v)
#define TO_INPUT3_TYPE_SAT(v) convert_int_sat(v)
#define AS_INPUT3_TYPE(v) as_int(v)
#define INPUT3_MAX_FUNC max
#define INPUT3_MIN_FUNC min
#define INPUT3_ABS_FUNC abs
#define INPUT3_TYPE_SIZE 4
#define INPUT3_IS_FP 0
...
#define OUTPUT_FEATURE_NUM 5120
#define OUTPUT_BATCH_NUM (shape_info[74] )
...
#define OUTPUT_BATCH_PITCH (1*1*1*1*1*1*5120)
...
#define TARGET_SEQ_LEN 1
#define NUM_HEADS 40
#define NUM_KV_HEADS 40
#define SOURCE_SEQ_LEN 1
...
#define STATIC_SCALE_VALUE_INV as_float(0x413509e7)/*1.131492e+01*/
#define STATIC_SCALE_VALUE as_float(0x3db50000)/*8.837891e-02*/
#define IS_PAGED_ATTENTION 1
