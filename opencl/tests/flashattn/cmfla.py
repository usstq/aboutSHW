...
if __name__ == "__main__":
    test_flash_attn_causal_batch1(batch=16, seq_len=11008, num_heads = 1, num_kv_heads = 1, head_size = 80)
    test_flash_attn_causal_batch1(batch=16, seq_len=11008, num_heads = 1, num_kv_heads = 1, head_size = 80, fuse_v=True)
